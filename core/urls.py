...
from .views import login_page, signup_page, dashboard_view, invmanagement_view, orders_view, suppliers_view, reports_view, settings_view, logout_view, changelog_view
